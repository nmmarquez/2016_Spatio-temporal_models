...
setwd("~/Documents/Classes/2016_Spatio-temporal_models/Week 3 -- Temporal Models/Lab/")
...
#obtain remainder 
co2.rem<-co2.stl$time.series[,"remainder"]
...
DLM_sim <- function(N = 100, seed = 123, sigma.obs = 1, 
                    sigma.proc = 0.5, a = -0.5, y1 = 10){
