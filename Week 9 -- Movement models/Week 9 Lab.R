...
# File structure
setwd( "C:/Users/James.Thorson/Desktop/Project_git/2016_Spatio-temporal_models/Week 9 -- Movement models/" )
...
# Simulation model
SimulationDomain = c("Mesh", "Grid")[2]
Dynamical_Model = c("Gompertz", "Ricker")[1]
n_t = 20
logmeanu0 = 1
alpha = 1
beta = 0.5
mvec = rep(0.1, 4)   # Movement in each of four cardinal directions
...
Opt = nlminb( start=Obj$par, objective=Obj$fn, gradient=Obj$gr_mod, upper=Upr, lower=Lwr, control=list("trace"=1, "eval.max"=1e4, "iter.max"=1e4))
