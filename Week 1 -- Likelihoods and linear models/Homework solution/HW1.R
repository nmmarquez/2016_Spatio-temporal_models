...
setwd( "C:/Users/James.Thorson/Desktop/Project_git/2016_classes_private/Spatio-temporal models/Week 1 -- Likelihoods and linear models/Homework solution" )
...
Table1 = array(NA, dim=c(3,3), dimnames=list(c("lognormal","gamma","invgauss"),c("loglike","num_params","pred_loglike_per_datum")) )
...
for(j in 1:3){
  ...
  # Step 3 -- test and optimize
  for(i in 1:3) Opt = nlminb( start=Obj$env$last.par.best, objective=Obj$fn, gradient=Obj$gr )
